...
namespace WarGameTOO
{
    ...
    public class Card : IComparable<Card>
    {
        ...
        // instead of having to write the compare function we just choose to compare their number values, will return 1, -1, or 0
        public int CompareTo(Card temp) // call it compareto, not overriding
        {
            return num.CompareTo(temp.num); // comapre the 2 cards
        }
